...
public class OrderAdapter extends ArrayAdapter<AddToCart> {
    ...
    public OrderAdapter(Context context, List<AddToCart> objects) {

        super(context, R.layout.single_pay_product, objects);
        this.object = objects;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            row = LayoutInflater.from(getContext()).inflate(R.layout.single_pay_product, parent, false);

            viewHolder = new ViewHolder();

            viewHolder.photo = row.findViewById(R.id.photo);
            viewHolder.name = row.findViewById(R.id.name);
            viewHolder.price = row.findViewById(R.id.price);
